  ...
  window.addEventListener('load', function () {
    ...
    tools.point = function () {
      ...
      this.mouseup = function (ev) {
        if (ferramenta.started) {
          ...
          document.getElementById("coordenadas_desenho").innerHTML = "<b> Coordenadas X e Y do Ponto </b>";
          document.getElementById("x_desenho").innerHTML = "<b>Coordenads X: </b> </br>"+ferramenta.x0;
          document.getElementById("y_desenho").innerHTML = "<b>Coordenads Y: </b> </br>"+ferramenta.y0;
        }
      };
    };
    ...
    tools.polygon = function () {
      ...
      this.mousemove = function (ev) {
        ...
        var xPos = Math.round(xCenter + radius * Math.cos(2 * Math.PI * 0 / edge));
        var yPos = Math.round(yCenter + radius * Math.sin(2 * Math.PI * 0 / edge));
        contexto.moveTo(xPos, yPos);

        coordenadas_X[0] = xPos;
        coordenadas_Y[0] = yPos;

        // Loop que passa pelos vertices e mapeia as linhas
        for (i = 1; i <= edge; i++) {
          // Determina as coordenadas do proximo vertice
          xPos = Math.round(xCenter + radius * Math.cos(2 * Math.PI * i / edge));
          yPos = Math.round(yCenter + radius * Math.sin(2 * Math.PI * i / edge));
      ...
      this.mouseup = function (ev) {
        if (ferramenta.started) {
          ...
          document.getElementById("coordenadas_desenho").innerHTML = "<b> Coordenadas X e Y do Polígono com "+edge.value+" vertices, separadas por ',' e sentido horário: </b>";
          document.getElementById("x_desenho").innerHTML = "<b>Coordenada Y: </b> </br>"+coordenadas_X;
          document.getElementById("y_desenho").innerHTML = "<b>Coordenada X: </b> </br>"+coordenadas_Y;
        }
      };
    };
